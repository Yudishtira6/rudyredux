                          ...
                          <g id="bubblegroup" fill="#000000">
                            ...
                            <animateTransform attributeType="xml"
                              ...
                              <g id="maskedliquid" mask="url(#liquidMask)">
                          		...
                          		<path d="M18,27" transform="translate(-24.17 -23.03)" style="fill:#fff"/>
                          	</svg>
                          </div>
                        </div>
                      );
