...
router.route('/getProduct').post(function(req,res){
  ...
  var options = {
    uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/products.json?apiVersion=5.4&appKey=narwhal&clientName='+req.body.clientName+'&filter=id:'+req.body.productId,
    headers: {
...
router.route('/syndicationDashboard').post(function(req,res){
  ...
  if (source['syndication'].length){
    ...
    var edgeOptions = {
      uri: 'http://sb2-int.bazaar.prod.us-east-1.nexus.bazaarvoice.com/api/v3/edges/to/'+clientName,
      headers: {
          'User-Agent': 'Request-Promise'
      },
      json: true // Automatically parses the JSON string in the response
    ...
    request(edgeOptions)
      .then(function (edgeBody) {
        ...
        var displayOptions = {
          uri: 'http://sb2-int.bazaar.prod.us-east-1.nexus.bazaarvoice.com/api/v3/displays/'+clientName,
          headers: {
              'User-Agent': 'Request-Promise'
          },
          json: true // Automatically parses the JSON string in the response
...
router.route('/blockedDashboard').post(function(req,res) {
  ...
  let displaySyndOpt = {
    uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/reviews.json?appkey=narwhal&clientname='+clientName+'&ApiVersion=5.4&filter=productid:'+productId+'&filter=IsSyndicated:true&keyproperty=syndication&limit=1',
    headers: {
        'User-Agent': 'Request-Promise'
    },
    json: true // Automatically parses the JSON string in the response
    ...
    .then(function (displayResults) {
      ...
      for(let i=0;i<len;i++){
          ...
          console.log('productId: ', syndProduct);
              let hagopt = {
                uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/reviews.json?appkey=narwhal&clientname='+syndClient+'&ApiVersion=5.4&filter=productid:'+syndProduct+'&limit=1&excludeFamily=true',
                headers: {
                    'User-Agent': 'Request-Promise'
                },
                json: true // Automatically parses the JSON string in the response
...
router.route('/familyDashboard').post(function(req,res) {
  ...
  for (let i = 0;i<len;i++){
    ...
    let hagopt = {
      uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/reviews.json?appkey=newRudy&clientname='+source.family[i][0]+'&ApiVersion=5.4&filter=productid:'+source.family[i][1]+'&limit=1&excludeFamily=true',
      headers: {
          'User-Agent': 'Request-Promise'
      },
      json: true // Automatically parses the JSON string in the response
...
router.route('/paginateAll').post(function(req,res){
  ...
  let pagopt = {
    uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/reviews.json?appkey=narwhal&clientname='+clientName+'&ApiVersion=5.4&filter=productid:'+productId+'&keyproperty=syndication&limit=100&offset='+(pageNumber*100),
    headers: {
        'User-Agent': 'Request-Promise'
    },
    json: true // Automatically parses the JSON string in the response
...
router.route('/paginateDisplayableSyndicated').post(function(req,res){
  ...
  var pageNumber = req.body.pageNumber;
  let pagopt = {
    uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/reviews.json?appkey=narwhal&clientname='+clientName+'&ApiVersion=5.4&filter=productid:'+productId+'&filter=IsSyndicated:true&keyproperty=syndication&limit=100&offset='+(pageNumber*100),
    headers: {
        'User-Agent': 'Request-Promise'
    },
    json: true // Automatically parses the JSON string in the response
...
router.route('/paginateNative').post(function(req,res){
  ...
  var pageNumber = req.body.pageNumber;
  let pagopt = {
    uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/reviews.json?appkey=narwhal&clientname='+clientName+'&ApiVersion=5.4&filter=productid:'+productId+'&excludeFamily=true&limit=100&offset='+(pageNumber*100),
    headers: {
        'User-Agent': 'Request-Promise'
    },
    json: true // Automatically parses the JSON string in the response
...
router.route('/paginateFamily').post(function(req,res){
  ...
  var pageNumber = req.body.pageNumber;
  let pagopt = {
    uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/reviews.json?appkey=narwhal&clientname='+clientName+'&ApiVersion=5.4&filter=productid:'+familyProductId+'&excludeFamily=true&limit=100&offset='+(pageNumber*100),
    headers: {
        'User-Agent': 'Request-Promise'
    },
    json: true // Automatically parses the JSON string in the response
...
router.route('/blockedReviews').post(function(req,res){
  ...
  for (let i=0;i<len;i++){
    ...
    // modcode blocked
    var hagmodopt = {
      uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/reviews.json?apiVersion=5.4&appKey=narwhal&clientName='+syndicationObject[i]["sourceName"]+'&keyProperty=syndication&filter=productid:'+syndicationObject[i]["productId"]+'&include=products&stats=reviews&filter=ModeratorCode:'+syndicationObject[i]["modCodes"].join()+'&attributes=moderatorCodes&limit=100',
      headers: {
          'User-Agent': 'Request-Promise'
      },
      json: true // Automatically parses the JSON string in the response
...
// start synd delay code block
        ...
        var hagdelayopt = {
          uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/reviews.json?apiVersion=5.4&appKey=narwhal&clientName='+syndicationObject[i]["sourceName"]+'&keyProperty=syndication&filter=productid:'+syndicationObject[i]["productId"]+'&include=products&stats=reviews&filter=submissiontime:gt:'+parseInt(last.getTime()/1000)+'&attributes=moderatorCodes&limit=100',
          headers: {
              'User-Agent': 'Request-Promise'
          },
          json: true // Automatically parses the JSON string in the response
...
// RatingsOnlyReviews block
        ...
        // } else {
          ...
          var hagratonlyopt = {
            uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/reviews.json?apiVersion=5.4&appKey=narwhal&clientName='+syndicationObject[i]["sourceName"]+'&keyProperty=syndication&filter=productid:'+syndicationObject[i]["productId"]+'&include=products&stats=reviews&filter=isratingsonly:true&attributes=moderatorCodes&limit=100',
            headers: {
                'User-Agent': 'Request-Promise'
            },
            json: true // Automatically parses the JSON string in the response
...
// start locale block code
        ...
        var haglocaleopt = {
          uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/reviews.json?apiVersion=5.4&appKey=narwhal&clientName='+syndicationObject[i]["sourceName"]+'&keyProperty=syndication&filter=productid:'+syndicationObject[i]["productId"]+'&include=products&stats=reviews&filter=ContentLocale:neq:'+syndicationObject[i]["locales"].join()+'&attributes=moderatorCodes&limit=100',
          headers: {
              'User-Agent': 'Request-Promise'
          },
          json: true // Automatically parses the JSON string in the response
...
router.route('/dashboard').post(function(req,res) {
  ...
  var batchOneOptions = {
    uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/batch.json?appkey=narwhal&clientname='+clientName+'&keyproperty=syndication&ApiVersion=5.4&resource.q0=reviews&filter.q0=productid:'+productId+'&filter.q0=issyndicated:true&limit.q0=1&resource.q1=statistics&filter.q1=productid:'+productId+'&stats.q1=reviews',
    headers: {
        'User-Agent': 'Request-Promise'
    },
    json: true // Automatically parses the JSON string in the response
  ...
  rp(batchOneOptions)
    .then(function (synRev) {
      ...
      var batch2Options = {
        uri: 'http://hagrid-bazaar-use1.prod.bazaarvoice.com/data/batch.json?appkey=narwhal&clientname='+clientName+'&excludeFamily=true&ApiVersion=5.4&resource.q0=reviews&filter.q0=productid:'+productId+'&limit.q0=1&resource.q1=reviews&filter.q1=productid:'+productId+'&limit.q1=1&filter.q1=isRatingsOnly:true',
        headers: {
            'User-Agent': 'Request-Promise'
        },
        json: true // Automatically parses the JSON string in the response
